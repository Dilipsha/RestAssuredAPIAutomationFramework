...
public class RestUtils {
    ...
    public static Response performPost(String endPoint,Object requestPayloadASPoja, Map<String,String> headers){
        RequestSpecification requestSpecification=getRequestSpecification(endPoint,requestPayloadASPoja,headers);
        Response response=requestSpecification.post();
        printRequestLogInReport(requestSpecification);
        printResponseLogInReport(response);
        return response;
